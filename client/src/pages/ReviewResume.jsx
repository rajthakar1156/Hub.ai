  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 bg-[#0c0c0e]">
      ...
      <form
        ...
        className="w-full max-w-lg p-4 bg-[#252627] rounded-lg "
      >
        ...
        <input
          ...
          className="w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-500 text-gray-400"
          required
        />
      ...
      <div className="w-full max-w-lg p-4 bg-[#252627] rounded-lg flex flex-col  min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
